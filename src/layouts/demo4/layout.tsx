...
export function Demo4Layout() {
 ...
 const contextData = useContext(SidebarContext);
    // const sideBarVisible = contextData?.sidebarMenu.length != 0 ? '--sidebar-width' : '--sidebar-width';
    ...
    <>
      ...
      <div className="flex grow">
        ...
        <div className="flex flex-col lg:flex-row grow pt-(--header-height) lg:pt-0">
          ...
          <div className={`flex grow bg-background border border-input lg:ms-(${sideBarVisible}) mt-0 mb-0`}>
